...
def main():
    ...
    with col1:
        ...
        if st.session_state.purchased_parts:
            ...
            if st.session_state.recommendations:
                ...
                for i, rec in enumerate(st.session_state.recommendations, 1):
                    with st.expander(f"#{i}: {rec}"):
                        ...
                        - **Compatibility**: ✅ Works well with your selected parts
                        """)
                        
                        # Add to build button
                        if st.button(f"Add {rec} to your build", key=f"add_{rec}"):
            ...
            st.info("Add some parts you own or plan to buy to get recommendations.")
